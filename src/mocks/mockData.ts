...
export const defaultTransBingoSteps: VendorNavigationStep[] = [
  ...
  { id: 'STEP-2', sequence: 2, action: 'FILL', selectorStrategy: 'data-testid', selector: "username-input", inputSource: 'CREDENTIAL_USERNAME', description: 'Enter username', timeoutMs: 5000, retryCount: 1, isRequired: true },
  { id: 'STEP-3', sequence: 3, action: 'FILL', selectorStrategy: 'data-testid', selector: "password-input", inputSource: 'CREDENTIAL_PASSWORD', description: 'Enter password', timeoutMs: 5000, retryCount: 1, isRequired: true },
  ...
  { id: 'STEP-8', sequence: 8, action: 'SELECT', selectorStrategy: 'data-testid', selector: "school-select", inputSource: '{{vendorSchoolCode}}', description: 'Select School from dropdown', timeoutMs: 5000, retryCount: 1, isRequired: true },
  { id: 'STEP-9', sequence: 9, action: 'SET_DATE', selectorStrategy: 'data-testid', selector: "from-date", inputSource: '{{fromDate}}', description: 'Set From Date = Business Date', timeoutMs: 5000, retryCount: 1, isRequired: true },
  { id: 'STEP-10', sequence: 10, action: 'SET_DATE', selectorStrategy: 'data-testid', selector: "to-date", inputSource: '{{toDate}}', description: 'Set To Date = Business Date', timeoutMs: 5000, retryCount: 1, isRequired: true },
